...
public class ExtendedSign implements BaseNonRelationalValueDomain<ExtendedSignLattice> {
    ...
    // -------------------------------------------------------------------------
    // Assume (guard refinement) — mirrors Sign.java's logic
    // -------------------------------------------------------------------------
    ...
    public ValueEnvironment<ExtendedSignLattice> assumeBinaryExpression(
        ...
        if (operator == ComparisonEq.INSTANCE) {
            ...
            // Refine over the three concrete sign atoms
            ExtendedSignLattice[] atoms = { ExtendedSignLattice.LT0, ExtendedSignLattice.EQ0, ExtendedSignLattice.GT0 };
