...
public class IntervaRealLatticeAlternative 
	...
	public static IntervaRealLatticeAlternative TOP = new IntervaRealLatticeAlternative(MathNumber.MINUS_INFINITY, MathNumber.PLUS_INFINITY);
	...
	@Override
		...
		public IntervaRealLatticeAlternative wideningAux(IntervaRealLatticeAlternative other) throws SemanticException {
			...
			if(l2.lt(l1)) {
				if(l2.lt(guard.multiply(MathNumber.MINUS_ONE))) {
