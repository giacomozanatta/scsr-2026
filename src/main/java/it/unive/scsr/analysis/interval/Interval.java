...
public class Interval implements BaseNonRelationalValueDomain<IntervalLattice>{
    ...
    public IntervalLattice evalBinaryExpression(BinaryExpression expression, IntervalLattice left,
        ...
        if(expression.getOperator() instanceof AdditionOperator) {
            ...
            if((l2.compareTo(MathNumber.ZERO) < 0 && u2.compareTo(MathNumber.ZERO) > 0) || l2.equals(MathNumber.ZERO) || u2.equals(MathNumber.ZERO))
                return IntervalLattice.TOP;

            MathNumber q1 = l1.divide(l2);
            MathNumber q2 = l1.divide(u2);
            MathNumber q3 = u1.divide(l2);
            MathNumber q4 = u1.divide(u2);
