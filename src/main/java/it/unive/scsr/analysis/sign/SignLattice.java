...
public class SignLattice
    ...
    public SignLattice lubAux(SignLattice other) throws SemanticException {
        if (this == SignLattice.POS &&
            ...
            return SignLattice.TOP;
        // in general should be handled all case... In this sign domain with POS, ZERO,
        // NEG, it is simply TOP
        return SignLattice.TOP;
    }
    ...
    // Other method implementations to use in Sign domain to assume and check
    // satisfability of some stuff
