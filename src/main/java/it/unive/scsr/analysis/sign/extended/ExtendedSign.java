...
/**
 * A non-relational sign analysis domain for extended integer signs.
 *
 * <p>This domain tracks the possible sign values of expressions and
 * supports arithmetic and comparison operations over the extended sign lattice.</p>
 */
