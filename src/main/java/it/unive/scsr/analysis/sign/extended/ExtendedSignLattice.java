...
/**
 * Represents the extended sign lattice for abstract integer sign values.
 *
 * <p>Each instance is a bitmask of possible sign atoms (negative, zero, positive)
 * and supports lattice operations like lub, glb, and satisfiability checks.</p>
 */
