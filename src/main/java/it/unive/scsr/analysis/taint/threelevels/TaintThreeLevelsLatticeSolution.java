...
private TaintThreeLevelsLatticeSolution(
	byte v) {
this.taint = v;
}
...
@Override
public TaintThreeLevelsLatticeSolution lubAux(
		TaintThreeLevelsLatticeSolution other)
...
@Override
public TaintThreeLevelsLatticeSolution wideningAux(
		TaintThreeLevelsLatticeSolution other)
	throws SemanticException {
// only happens with clean and tainted, that are not comparable
return TOP;
...
@Override
public TaintThreeLevelsLatticeSolution or(
		TaintThreeLevelsLatticeSolution other)
	throws SemanticException {
