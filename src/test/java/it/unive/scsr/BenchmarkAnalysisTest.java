...
public class BenchmarkAnalysisTest {

    private static final String DIR = "students/SCSR2026Programs/";
    ...
    // =========================================================================
    // Division-by-zero — 10 student programs
    // =========================================================================
    ...
    @Test
    public void testDivZeroInterval1() throws ParsingException, AnalysisException {
        runDivZero("895227_897270_div_by_zero_interval_1.imp", "dz-interval1");
    }

    @Test
    public void testDivZeroInterval2() throws ParsingException, AnalysisException {
        runDivZero("895227_897270_div_by_zero_interval_2.imp", "dz-interval2");
    }

    @Test
    public void testDivZeroInterval3() throws ParsingException, AnalysisException {
        runDivZero("895227_897270_div_by_zero_interval_3.imp", "dz-interval3");
    }

    // =========================================================================
    // Overflow — 10 student programs
    // =========================================================================
    ...
    @Test
    public void testOverflowInterval1() throws ParsingException, AnalysisException {
        runOverflow("895227_897270_overflow_interval_1.imp", "ov-interval1");
    }

    @Test
    public void testOverflowInterval2() throws ParsingException, AnalysisException {
        runOverflow("895227_897270_overflow_interval_2.imp", "ov-interval2");
    }

    @Test
    public void testOverflowInterval3() throws ParsingException, AnalysisException {
        runOverflow("895227_897270_overflow_interval_3.imp", "ov-interval3");
    }

    // =========================================================================
    // Strings (HTTP/DotCom) — 10 student programs
    // =========================================================================
    ...
    @Test
    public void testStringsHttp1() throws ParsingException, AnalysisException {
        runStrings("895227_897270_http_string_1.imp", "str-http1");
    }

    @Test
    public void testStringsHttp2() throws ParsingException, AnalysisException {
        runStrings("895227_897270_http_string_2.imp", "str-http2");
    }

    @Test
    public void testStringsDotCom1() throws ParsingException, AnalysisException {
        runStrings("895227_897270_dot_com_string_1.imp", "str-dotcom1");
    }

    // =========================================================================
    // Taint (three levels) — 10 student programs
    // =========================================================================
    ...
    public void testTaintThreeLevel1() throws ParsingException, AnalysisException {
        runTaint("1003406_three_taint_3.imp", "taint-pathtraversal",
                Arrays.asList("getUserInput"),
                Arrays.asList("sanitizeParam"),
                Arrays.asList("readFile"));
    }

    @Test
    public void testTaintPath1() throws ParsingException, AnalysisException {
        runTaint("1003406_three_taint_1.imp", "taint-path1",
                Arrays.asList("getExternalRequest", "getUserInput"),
                Arrays.asList("sanitizeParam", "basicSanitize"),
                Arrays.asList("executeSystemCommand"));
    }
    ...
    @Test
    public void testTaintPath2() throws ParsingException, AnalysisException {
        runTaint("1003406_three_taint_2.imp", "taint-path2",
                Arrays.asList("GetRequest"),
                Arrays.asList("sanitizeInput"),
                Arrays.asList("logAudit"));
    }
