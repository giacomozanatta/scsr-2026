...
import it.unive.scsr.checkers.DeadCodeChecker;
...
public class DeadCodeAnalysisTest {
    @Test
    public void testDeadCodeAnalysis() throws ParsingException, AnalysisException {
        // we parse the program to get the CFG representation of the code in it
        Program program = IMPFrontend.processFile("inputs/project/deadCode/deadCode.imp");

        // we build a new configuration for the analysis
        LiSAConfiguration conf = new DefaultConfiguration();

        // we specify where we want files to be generated
        conf.workdir = "outputs/deadCode";
        ...
        conf.semanticChecks.add(new DeadCodeChecker<>());
