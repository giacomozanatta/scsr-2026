...
public class NumericalAnalysesTest {
    ...
    public void testDivByZeroIntervalAnalysis() throws ParsingException, AnalysisException {
        ...
        Program program = IMPFrontend.processFile("inputs/project/other/894579_896954_divisionbyzero_1-2.imp");

        // we build a new configuration for the analysis
        LiSAConfiguration conf = new DefaultConfiguration();

        // we specify where we want files to be generated
        conf.workdir = "outputs/project/divByZero";
    ...
    public void testDivByZeroPentagonAnalysis() throws ParsingException, AnalysisException {
        ...
        // we specify where we want files to be generated
        conf.workdir = "outputs/project/divByZero/pentagons";
    ...
    public void testOverflowInterval8bitsAnalysis() throws ParsingException, AnalysisException {
        // we parse the program to get the CFG representation of the code in it
        Program program = IMPFrontend.processFile("inputs/project/other/894579_896954_overunderflow_1-2.imp");

        // we build a new configuration for the analysis
        LiSAConfiguration conf = new DefaultConfiguration();

        // we specify where we want files to be generated
        conf.workdir = "outputs/project/overflow";
