...
public class OverflowIntervalTest {
    ...
    public void testOverflowInterval1() throws ParsingException, AnalysisException {
        ...
        Program program = IMPFrontend.processFile("inputs/1003567_overflow_1.imp");

        // we build a new configuration for the analysis
        LiSAConfiguration conf = new DefaultConfiguration();

        // we specify where we want files to be generated
        conf.workdir = "outputs/1003567_overflow_1";
    ...
    public void testOverflowInterval2() throws ParsingException, AnalysisException {
        // we parse the program to get the CFG representation of the code in it
        Program program = IMPFrontend.processFile("inputs/1003567_overflow_2.imp");

        // we build a new configuration for the analysis
        LiSAConfiguration conf = new DefaultConfiguration();

        // we specify where we want files to be generated
        conf.workdir = "outputs/1003567_overflow_2";
    ...
    public void testOverflowInterval3() throws ParsingException, AnalysisException {
        // we parse the program to get the CFG representation of the code in it
        Program program = IMPFrontend.processFile("inputs/1003567_overflow_3.imp");

        // we build a new configuration for the analysis
        LiSAConfiguration conf = new DefaultConfiguration();

        // we specify where we want files to be generated
        conf.workdir = "outputs/1003567_overflow_3";
    ...
    public void testOverflowInterval() throws ParsingException, AnalysisException {
        ...
        // we specify where we want files to be generated
        conf.workdir = "outputs/1003567_div_by_zero_3.imp";
