...
import it.unive.scsr.checkers.ParityChecker;
...
public class ParityAnalysisTest {
    ...
    @Test
    public void testParityAnalysis2() throws ParsingException, AnalysisException {
        ...
        conf.semanticChecks.add(new ParityChecker<>());
