...
/**
 * Test class for the parity analysis. 
 * 
 * @brief It runs the parity analysis on the program in inputs/parity.imp, simple implementation of the factorial function, 
 *      and checks that the results are correct.
 * 
