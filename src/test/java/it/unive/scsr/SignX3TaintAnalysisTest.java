...
import it.unive.scsr.analysis.signx3taint.SignX3Taint;
import it.unive.scsr.analysis.signx3taint.SignX3TaintChecker;
...
public class SignX3TaintAnalysisTest {
    ...
    @Test
    public void testSignX3TaintAnalysis() throws ParsingException, AnalysisException {
        // we parse the program to get the CFG representation of the code in it
        Program program = IMPFrontend.processFile("inputs/signx3taint.imp");

        // we build a new configuration for the analysis
        LiSAConfiguration conf = new DefaultConfiguration();

        // we specify where we want files to be generated
        conf.workdir = "outputs/signx3taint";
        ...
        for(CFG cfg : program.getAllCFGs()) {
        	...
        	if(isSource(name))
        		...
        		cfg.getDescriptor().addAnnotation(SignX3Taint.SINK_ANNOTATION);
        }
