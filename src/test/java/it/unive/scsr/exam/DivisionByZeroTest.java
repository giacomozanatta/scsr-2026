...
public class DivisionByZeroTest {
  ...
  public void testIntervalDivByZero() throws ParsingException, AnalysisException {
    String inputPath = "inputs/exam/personal/divisionbyzero.imp";
    String outputPath = "outputs/exam/personal/divisionByZeroInterval";
  ...
  @Test
  public void testPentagonDivByZero() throws ParsingException, AnalysisException {
    String inputPath = "inputs/exam/personal/divisionbyzero.imp";
