...
public class StringTest {
  ...
  public void testStringPrefixAnalysis() throws ParsingException, AnalysisException {
    String inputPath = "inputs/exam/personal/string.imp";
    String outputPath = "outputs/exam/personal/stringPrefix";
    ...
    // A report file (.json) containing the warning triggered by the analysis can be
    // found in the analysis output folder
  ...
  public void testStringSuffixAnalysis() throws ParsingException, AnalysisException {
    String inputPath = "inputs/exam/personal/string.imp";
    String outputPath = "outputs/exam/personal/stringSuffix";
