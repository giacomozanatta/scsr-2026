...
import it.unive.scsr.analysis.signtaint.TaintedNegativeSpeedChecker;
import it.unive.scsr.analysis.signtaint.extsigntaint.ExtendedSignTaint;
import it.unive.scsr.analysis.signtaint.extsigntaint.TaintedNegativeSpeedExtSignChecker;
...
public class SignTaintTest {

    String[] nameSource = {"source1", "source2", "GetRequest"};
    ...
    public void testExtendedSignTaintAnalysis() throws ParsingException, AnalysisException {
        ...
        conf.semanticChecks.add(new TaintedNegativeSpeedExtSignChecker<>());
    ...
    public void testSignTaintAnalysis() throws ParsingException, AnalysisException {
        ...
        // added checker to the analysis
        conf.semanticChecks.add(new TaintedNegativeSpeedChecker<>());
